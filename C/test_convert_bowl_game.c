...
static char *convertBowlGame_ShouldReturnABowlGameObject_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     ...
     bowl_game_s *bowl_game = convertBowlGame( &rom, &save_state, 0, bg_None );
...
static char *convertBowlGame_ShouldReturnBowlGameWithTeamsThatPlayed_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
     ...
     int expected_road_team_id = save_state.playoffs[save_state.game_of_week[0]].match.road[0] + 1;
     int expected_home_team_id = save_state.playoffs[save_state.game_of_week[0]].match.home[0] + 1;
...
static char *convertBowlGame_ShouldReturnTeamsWithStatsFromGame_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
     ...
     bowl_game_s *bowl_game = convertBowlGame( &rom, &save_state, 5, bg_RoseBowl );
     ...
     int expected_road_score = hex2number( save_state.playoffs[save_state.game_of_week[0]].road_score[0] );
     int expected_home_score = hex2number( save_state.playoffs[save_state.game_of_week[0]].home_score[0] );
...
static char *convertBowlGame_ShouldReturnTeamsWithOffenseStatsFromGame_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
...
static char *convertBowlGame_ShouldReturnTeamsWithDefenseStatsFromGame_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
...
static char *convertBowlGame_ShouldReturnTeamsWithKickingStatsFromGame_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
...
static char *convertBowlGame_ShouldReturnTeamsWithPlayerStatsFromGame_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
...
static char *convertBowlGame_ShouldRoundNegativeIntReturnYardsToZero_GivenTsbRomAndSaveState()
{
     tsbrom_s          rom        = { 0 };
     nst_save_state_s  save_state = { 0 };
...
static void check_convert_bowl_game_error()
{
...
{
     run_test( convertBowlGame_ShouldReturnABowlGameObject_GivenTsbRomAndSaveState,               check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnBowlGameWithTeamsThatPlayed_GivenTsbRomAndSaveState,   check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnTeamsWithStatsFromGame_GivenTsbRomAndSaveState,        check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnTeamsWithOffenseStatsFromGame_GivenTsbRomAndSaveState, check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnTeamsWithDefenseStatsFromGame_GivenTsbRomAndSaveState, check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnTeamsWithKickingStatsFromGame_GivenTsbRomAndSaveState, check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldReturnTeamsWithPlayerStatsFromGame_GivenTsbRomAndSaveState,  check_convert_bowl_game_error );
     run_test( convertBowlGame_ShouldRoundNegativeIntReturnYardsToZero_GivenTsbRomAndSaveState,   check_convert_bowl_game_error );
}
