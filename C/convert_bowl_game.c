...
{
     save_state->playoffs[save_state->game_of_week[0]].road_score[0] = state_file[0x3d1];
     save_state->playoffs[save_state->game_of_week[0]].home_score[0] = state_file[0x3d6];
}
